...
/**
 * Structured Operational Recommendation generated by the AI Operations Manager.
 */
export interface AIOperationalRecommendation {
  ...
  confidenceScore: number; // Percentage: 0 to 100
  operationalImpact: string;
  suggestedNextSteps: string[];
}

/**
 * Top-level response schema for the AI Operations Manager dashboard insights.
 */
export interface AIOperationsManagerInsights {
  mode?: "live" | "fallback";
